<div class="w-1/4 bg-gray-50 p-4 border-r">
    <ul class="space-y-2">
        @php
            $menuItems = [
                ['label' => 'Informasi Umum', 'route' => route('profile-seeker'), 'active' => 'profile-seeker'],
                ['label' => 'CV & Portfolio', 'route' => route('cv-and-portofolio'), 'active' => 'cv-and-portofolio'],
                ['label' => 'Ubah Kata Sandi', 'route' => route('change-password'), 'active' => 'change-password'],
            ];
        @endphp
