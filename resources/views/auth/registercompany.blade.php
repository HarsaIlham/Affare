            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow-md px-6 pt-6">
                ...
                <div class="step active" id="step1">
                    ...
                    <div>
                        ...
                        <input type="text"
                            class=" border-gray-950 border bg-slate-200 py-1 w-full focus:border-blue-500 focus:bg-white focus:outline-none bg-opacity-50 rounded-md text-black px-2"
                            name="no_telepon" id="no_telepon" placeholder="Masukkan No. Telepon Perusahaan" required
                ...
                <div class="step" id="step2">
                    <label for="website" class="block mb-2 text-sm pt-4 font-medium text-gray-900">Website</label>
                    <input type="text"
                        class=" border-gray-950 border bg-slate-200 py-1 w-full focus:border-blue-500 focus:bg-white focus:outline-none bg-opacity-50 rounded-md text-black px-2"
                        name="website" id="website" placeholder="Masukkan URL Website Perusahaan (opsional)" value="{{ old('website') }}">
                    @error('website')
                        <div class="text-red-500 text-xs">{{ $message }}</div>
                    @enderror
                    <label for="bio" class="block mb-2 text-sm pt-4 font-medium text-gray-900">Bio</label>
                    ...
                    <input type="text"
                        class=" border-gray-950 border bg-slate-200 py-1 w-full focus:border-blue-500 focus:bg-white focus:outline-none bg-opacity-50 rounded-md text-black px-2"
                        name="linkedin" id="linkedin" placeholder="Masukkan URL Linkedin (opsional)" value="{{ old('linkedin') }}">
                    @error('linkedin')
                        <div class="text-red-500 text-xs">{{ $message }}</div>
                    @enderror
