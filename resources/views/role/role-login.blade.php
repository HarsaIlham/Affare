        ...
        <div class="flex items-center min-h-[90vh] justify-center flex-col ">
            ...
            <div class="bg-white pt-6 px-8 pb-10 rounded-2xl shadow-lg items-center md:flex-row md:items-start">
                ...
                <div class="  flex justify-center gap-8">
                    <!-- Applicant Section -->
                    <div
                        class="bg-[#5D8DE2] rounded-tl-[87px] rounded-tr-[15px] rounded-bl-[87px] rounded-br-[87px] shadow-lg p-6 w-72 hover:bg-blue-400 cursor-pointer" onclick="window.location.href = '{{ route('loginseeker') }}'">
                    ...
                    <!-- Employer Section -->
                    <div
                        class="bg-[#E1EFFF] rounded-tl-[15px] rounded-tr-[87px] rounded-bl-[87px] rounded-br-[87px] shadow-lg p-6 w-72 hover:bg-blue-200 cursor-pointer" onclick="window.location.href = '{{ route('logincompany') }}'">
